...
UINT8	CH549DiskConnect( void )
{
	...
	if ( rhub_idx1 < 4 ) {  /* 内置Root-HUB下的USB设备 */
		if ( ( rhub_idx1 & 0x02 ? UHUB2_3_CTRL : UHUB0_1_CTRL ) & ( rhub_idx1 & 0x01 ? bUH1_PORT_EN : bUH0_PORT_EN ) ) {  /* 内置Root-HUB下的USB设备存在且未插拔 */
...
mDiskDisconn:
		...
		if ( ( rhub_idx2 & 0x02 ? UHUB2_3_CTRL : UHUB0_1_CTRL ) & ( rhub_idx2 & 0x01 ? bUH1_PORT_EN : bUH0_PORT_EN ) ) {  /* 内置Root-HUB下的外部HUB存在且未插拔 */
