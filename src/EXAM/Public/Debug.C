...
* Description    : CH545时钟选择和配置函数,复位默认使用内部晶振，Fsys=12MHz，
...
* Description    : CH545串口0初始化,默认使用T1作波特率发生器，也可使用T2
...
/*******************************************************************************
* Function Name  : CH545UART0SendByte
...
/*******************************************************************************
* Function Name  : CH545WDTModeSelect
...
/*******************************************************************************
* Function Name  : CH545WDTFeed
* Description    : CH545看门狗喂狗
