...
* Version            : V1.0
* Date               : 2020/07/06
* Description        : CH545模拟USB Module,厂商自定义接口设备，需要安装驱动，
                       驱动搜索CH37XDRV或者安装ISPTool会自动安装该设备类驱动，
                       该设备类除了控制传输外，还有端点2批量上下传和端点1中断上传，
...
// 产品信息
UINT8C	MyProdInfo[] = { 0x0C, 0x03, 'C', 0, 'H', 0, '5', 0, '4', 0, '5', 0 };
...
UINT8X	Ep2Buffer[MIN(64,ENDP2_IN_SIZE+2)+MIN(64,ENDP2_OUT_SIZE+2)] _at_ (MIN(64,THIS_ENDP0_SIZE+2)+MIN(64,ENDP1_IN_SIZE+2));	// OUT+IN,必须是偶地址
