...
void main( ) 
{
    ...
    CAP2Init(2);                                                               //T2 CAP2(P11)设置，任意沿捕捉
    CAP1Init(2);                                                               //T2 CAP1(P10)设置，任意沿捕捉
    TR2 = 1;                                                                   //T2定时器启动
    ET2 = 1;                                                                   //T2定时器中断开启
    EA  = 1;
#endif
...
#if Timer1_INTERRUPT
/*******************************************************************************
* Function Name  : Timer1Interrupt(void)
...
#if Timer2_INTERRUPT
/*******************************************************************************
* Function Name  : Timer2Interrupt(void)
* Description    : Timer2 中断服务程序，延时20ms
*******************************************************************************/
UINT16 tmr2=0;
